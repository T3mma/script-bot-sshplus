...
msg02='\033[1;37m\033[1;33mNombre mui corto (MIN: 2 CARACTERS)\033[1;31m'
msg03='\033[1;37m\033[1;33mNombre mui grande (MAX: 5 CARACTERES)\033[1;31m'
msg04='\033[1;37m\033[1;33mContraseña Nula\033[1;31m'
msg05='\033[1;37m\033[1;33mContraseña muito curta\033[1;31m'
msg06='\033[1;37m\033[1;33mContraseña muito grande\033[1;31m'
msg07='\033[1;37m\033[1;33mDuracion Nula\033[1;31m'
msg08='\033[1;37m\033[1;33mDuracion invalida, utilize números\033[1;31m'
msg09='\033[1;37m\033[1;33mDuracion máxima de un ano\033[1;31m'
msg11='\033[1;37m\033[1;33mLimite Nulo\033[1;31m'
msg12='\033[1;37m\033[1;33mLimite invalido, utilize números\033[1;31m'
msg13='\033[1;37m\033[1;33mLimite maximo de 999\033[1;31m'
msg14='\033[1;37m\033[1;33mUsuario Ya Existe\033[1;31m'
msg15='\033[1;37m\033[1;33m(Solo numeros) GB = Min: 1gb Max: 1000gb\033[1;31m'
msg16='\033[1;37m\033[1;33m(Solo numeros)\033[1;31m'
msg17='\033[1;37m\033[1;33m(Sim imformacion - Para Cancelar Digite CRTL + C)\033[1;31m'
[[ $(awk -F" " '{print $2}' /usr/lib/licence) == "@KIRITO_SSH" ]] && {
    err_fun () {
        case $1 in
        1)msg -verm "$(fun_trans "Usuário Nulo")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        2)msg -verm "$(fun_trans "Nombre mui corto (MIN: 2 CHARACTERS)")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        3)msg -verm "$(fun_trans "Nombre mui grande (MAX: 5 CARACTERES)")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        4)msg -verm "$(fun_trans "Senha Nula")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        5)msg -verm "$(fun_trans "Paswors mui corta")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        6)msg -verm "$(fun_trans "Pasword mui grande")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        7)msg -verm "$(fun_trans "Duracion Nula")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        8)msg -verm "$(fun_trans "Duracion invalida, utilize números")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        9)msg -verm "$(fun_trans "Duracion maxima de um ano")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
	    ...
	    15)msg -verm "$(fun_trans "(Solo números) GB = Min: 1gb Max: 1000gb")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
	    16)msg -verm "$(fun_trans "(Solo números)")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
	    17)msg -verm "$(fun_trans "(Sim imformacion - Para Cancelar Digite CRTL + C)")"; sleep 4s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
        esac
    }
    ...
    echo -e "\033[1;37m\033[1;33mINSTALADO COM EXITO 😎✔✅!\033[1;31m"
    ...
    echo -e "\033[1;37m• \033[1;33mEscoja la opcion 3 y coloque tu dominio o Host ej: vps10.com\033[1;31m"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    v2ray stream
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    ...
    portv () {
    echo -e "\E[44;1;37m            EDITAR PUERTO V2RAY             \E[0m"
    v2ray port
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    fun_v2raymanager
    ...
    stats () {
    echo -e "\E[44;1;37m            ESTADISTICAS DE CONSUMO             \E[0m"
    v2ray stats
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    fun_v2raymanager
    ...
    unistallv2 () {
    source <(curl -sL https://raw.githubusercontent.com/vpsvip7/SSHPLUS/main/Modulos/v2ray) --remove > /dev/null 2>&1
    rm -rf /etc/SSHPlus/RegV2ray > /dev/null 2>&1
    echo -e "\n\033[1;32mV2RAY BORRADO CON EXITO !\033[0m"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    fun_v2raymanager
    }
    infocuenta () {
    echo -e "\E[44;1;37m            INFORMACION DE CUENTA             \E[0m"
    v2ray info
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    fun_v2raymanager
    ...
    echo ""
    while true; do
    echo -ne "\e[91m >> Digite un usuario: \033[1;92m"
         read -p ": " nick
    ...
    echo ""
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\e[92m           UUID ADICIONADO CON EXITO "
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\033[1;37m• \033[1;33mEnter Para Continuar\033[1;31m" && read enter
    fun_v2raymanager
    }
    ...
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -ne "\e[91m >> Digite UUID para eliminar:\n \033[1;92m " && read uuidel
    ...
    clear
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "\E[44;1;37m            LIMITAR MB X PUERTO | UUID V2RAY             \E[0m"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    ###VER
    estarts () {
    VPSsec=$(date +%s)
    ...
    ## MENU
    echo -e "\033[1;37m\033[1;33m[1] > LIMITAR DATOS x PORTA\033[1;31m"
    ...
    fun_v2raymanager() {
		while true $x != "ok"; do
			...
			clear
			echo -e "\E[44;1;37m                MENU V2RAY                 \E[0m\n"
            ...
            echo -e "\033[1;32mSERVICIO: \033[1;33mV2RAY \033[1;32m$xv2ray1\033[1;37m" 
...
[\033[1;36m04\033[1;31m] \033[1;37m• \033[1;33mEDITAR PUERTO V2RAY\033[1;31m
...
[\033[1;36m08\033[1;31m] \033[1;37m• \033[1;33mINFO DE CUENTA\033[1;31m
...
[\033[1;36m13\033[1;31m] \033[1;37m• \033[1;33mVOLVER \033[1;32m<\033[1;33m<\033[1;31m< \033[1;31m
